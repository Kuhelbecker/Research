...
namespace CinemaMVC.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            return View(this._repository.List);
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Title")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title")] Movie movie)
        {
            if (ModelState.IsValid)
            {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                (this._repository as MovieRepository).Dispose();
            }
